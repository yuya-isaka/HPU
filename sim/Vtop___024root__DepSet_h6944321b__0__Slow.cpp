...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->M_AXIS_TDATA = VL_RAND_RESET_Q(64);
    ...
    vlSelf->S_AXIS_TDATA = VL_RAND_RESET_Q(64);
    ...
    vlSelf->top__DOT__mat_a = VL_RAND_RESET_I(3);
    ...
    vlSelf->top__DOT__sum_update = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__exec_src_data = VL_RAND_RESET_I(32);
    vlSelf->top__DOT____Vcellinp__src_buf__exec_src_addr = VL_RAND_RESET_I(6);
    vlSelf->top__DOT____Vcellinp__src_buf__src_a = VL_RAND_RESET_I(5);
    ...
    vlSelf->top__DOT__src_ctrl__DOT__i = VL_RAND_RESET_I(4);
    ...
    vlSelf->top__DOT__exe_ctrl__DOT__j = VL_RAND_RESET_I(3);
    ...
    for (int __Vi0=0; __Vi0<16; ++__Vi0) {
        vlSelf->top__DOT__src_buf__DOT__buff0[__Vi0] = VL_RAND_RESET_Q(64);
    }
    vlSelf->top__DOT__src_buf__DOT__wd0 = VL_RAND_RESET_Q(64);
    for (int __Vi0=0; __Vi0<16; ++__Vi0) {
        vlSelf->top__DOT__src_buf__DOT__buff1[__Vi0] = VL_RAND_RESET_Q(64);
    }
    vlSelf->top__DOT__src_buf__DOT__wd1 = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__src_buf__DOT__ia_ = VL_RAND_RESET_I(2);
    ...
    vlSelf->top__DOT__dst_buf__DOT__stream_0 = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__dst_buf__DOT__stream_1 = VL_RAND_RESET_Q(64);
